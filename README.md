...
0 0000 0.0.0 0000.0000.0000 черный
1 0001 0.0.F 0000.0000.1111 синий
2 0010 0.F.0 0000.1111.0000 светло-зеленый, салатный
3 0011 0.F.F 0000.1111.1111 светло-голубой, бирюзовый
4 0100 F.0.0 1111.0000.0000 красный
5 0101 F.0.F 1111.0000.1111 розовый
6 0110 F.F.0 1111.1111.0000 светло-оранжевый, желтый
7 0111 F.F.F 1111.1111.1111 белый
8 1000 0.0.A 0000.0000.1010 темно-синий
9 1001 0.A.0 0000.1010.0000 зеленый
A 1010 0.A.A 0000.1010.1010 голубой
B 1011 A.0.0 1010.0000.0000 темно-красный, бордовый
C 1100 A.0.A 1010.0000.1010 темно-розовый, фиолетовый
D 1101 A.A.0 1010.1010.0000 оранжевый
E 1110 A.A.A 1010.1010.1010 серый
F 1111 0.0.0 0000.0000.0000 нет цвета, прозрачный

Каждый цвет в палитре можно задавать как яркостную составляющую (0-16) трех цветов (красный, зеленый, синий) в ЭЛТ-мониторах и телевизорах.

Таким образом, цвета в палитре можно настроить 12 битами (000-FFF), где 0 - самый темный цвет, F - самый яркий.

Таким образом:
000 - черный,
FFF - белый,
F00 - самый яркий красный,
0F0 - самый яркий зеленый,
00F - самый яркий синий.

Однако ЭЛТ мониторы и тем более телевизоры не всегда могут воспроизвести самые темные и самые яркие цвета. Их реальная яркость лежит где-то в пределах от 1 до 15, иногда даже меньше. Это значит, что разницы между цветами 0 и 1 или F и E вы скорее всего не увидите.

Еще 4 битами (0-F) кодируется номер палитры. Вы можете хранить в видеопамяти до 4 палитр и переключаться между ними. По-умолчанию установлена цветная и черно-белая палитры. Остальные оставлены пустыми на нужды программ.

Таким образом, максимальное количество цветов, которые вы физически можете использовать в игре - 60 (не забываем про прозрачный цвет) из почти 4096 возможных.

Сменой палитры могут достигаться такие эффекты как анимация фона, смена дня и ночи, погодные условия.
...
Цвет видеоподсистемы RX86 основан на фиксированной палитре из 256 цветов.
...
Сами же цвета в палитре теперь можно настроить 24 битами.

По-прежнему реальная яркость лежит где-то в пределах от 8 до 240 и это значит, что яркостные биты можно задавать в диапазоне от 08 до EF.
...
Нам нужно будет позиционировать экран игры по центру экрана нашей машины.

Если мы портируем игру на RX86, то мы можем использовать любую нужную нам палитру, а за счет увеличенного разрешения, можем более детально прорисовать спрайты.
